...
@section('title', 'Gán Khuyến Mãi Cho Suất Chiếu')
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.ticket-promotions.store') }}">
                        ...
                        <div class="text-right">
                            ...
                            <button type="submit" class="btn btn-primary">Gán Khuyến Mãi</button>
                        </div>
