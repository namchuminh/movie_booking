...
@section('title', 'Chỉnh Sửa Vé Xem Phim')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Chỉnh Sửa Vé</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Chỉnh sửa thông tin vé</h3>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.tickets.update', $ticket->id) }}">
                            ...
                            <select name="showtime_id" id="showtimeSelect" class="form-control">
                                ...
                                @foreach($showtimes as $show)
                                    <option 
                                        ...
                                        {{ old('showtime_id', $ticket->showtime_id) == $show->id ? 'selected' : '' }}
                                    >
                            ...
                            <select name="seat_id" id="seatSelect" class="form-control">
                                ...
                                @foreach($seats as $seat)
                                    <option 
                                        ...
                                        {{ old('seat_id', $ticket->seat_id) == $seat->id ? 'selected' : '' }}
                                    >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="username" class="form-control" value="{{ old('username', $ticket->user->username ?? '') }}" placeholder="Nhập tên người dùng">
...
<script>
    ...
    function updatePrice() {
        ...
        const total = Math.floor(showtimePrice + seatPrice);
