        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Nhập thông tin ghế</h3>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.seats.store') }}">
                        ...
                        <div class="form-group">
                            <label>Mã Ghế</label>
                            <input type="text" name="seat_code" class="form-control" value="{{ old('seat_code') }}" placeholder="A1, B2...">
                        ...
                        <div class="form-group">
                            <label>Giá Ghế</label>
                            <input type="text" name="price" class="form-control" value="{{ old('price') }}" placeholder="Nhập giá ghế">
